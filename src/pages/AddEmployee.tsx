...
export default function AddEmployee() {
  ...
  const renderStep = () => {
    switch (step) {
      ...
      case 1: return (<div>
        <div className="form-row"><div className="form-group"><label className="form-label">Contact 1 *</label><input className="input" value={contact1} onChange={e => setContact1(e.target.value)} /></div><div className="form-group"><label className="form-label">Contact 2</label><input className="input" value={contact2} onChange={e => setContact2(e.target.value)} /></div></div>
