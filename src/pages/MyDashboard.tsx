...
export default function MyDashboard() {
  const { employees, leaveRequests, setLeaveRequests, attendanceData } =
    useData();
  ...
  // Get employee data for EMP001 from context
  const emp = employees.find((e) => e.id === "EMP001");
      ...
      <div className="card">
        ...
        {[
          ...
          >
            ...
            <span
              className={`pill ${b.days === 0 ? "pill-green" : "pill-blue"}`}
            >
        ...
        footer={
          <>
            ...
            <button
              ...
              onClick={() => {
                // Add leave request to DataContext
                const newRequest = {
                  id: "LR" + String(Date.now()).slice(-6),
                  empId: "EMP001",
                  empName: empName,
                  leaveType: leaveType.split(" (")[0],
                  from: fromDate,
                  to: toDate,
                  days: daysRequested,
                  reason: reason,
